...
text(.77,.89,['{\itt} = ' num2str(round(sol2.t(ind(i))/3600,1)) ' h'],'Units','normalized','FontSize', 10);
if i == 1
    text(-.2,1.05,'a','Units','normalized','FontSize', 14,'fontweight', 'bold');  
end
