...
switch All
case 'on'
    Lyo = 'on'; FreezingVISF = 'on'; FreezingSto = 'on'; PrimDry = 'on'; SecDry = 'on'; Choked = 'on';
end

switch None 
case'on'
    Lyo = 'off'; FreezingVISF = 'off'; FreezingSto = 'off'; PrimDry = 'off'; SecDry = 'off'; Choked = 'on';
end
...
fig_freeze = figure; 
for i = 1:5
    tic; sol = Sim_Freezing_Sto2(ip); toc;
...
case 'on'
ip0 = get_inputdata;
ip = overwrite_inputdata(ip0,'StoVISF_freezing2');
...
% Plotting
fig_VISF = figure; 
plot_Tavg(time,Temp); hold on;
load('Data_VISF.mat')
plot(Data.T(:,2),Data.T(:,1),'o')
